...
Manual workflow for testing the experiment with product data:
...
Automation flow pseudocode to mutate product data using a patch object proposed by the agent:
